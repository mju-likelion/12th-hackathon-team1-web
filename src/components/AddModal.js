...
const AddModal = ({closeModal, ingredientValue, storageName, closeIngredientBox}) => {
  const handleWrapperClick = (e) => {
    e.stopPropagation();
  };
  
  const [foodData, setFoodData] = useRecoilState(dataAtom);
  ...
  const handleSave = () => {
    ...
    setFoodData([...foodData, newFoodItem]);
    closeModal();
    closeIngredientBox();
  };
