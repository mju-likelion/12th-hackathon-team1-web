      ...
      <WrapperBox onClick={(e) => e.stopPropagation()}>
        <Wrapper>
          ...
          <SmallWrapper>
            <TextBoxWrapper>
                ...
                <NameBox>
                  <TextBox>
                    {foodData.expiredDate
                      ? `${foodData.expiredDate.split("-")[0]}.${
                          foodData.expiredDate.split("-")[1]
                        }.${foodData.expiredDate.split("-")[2]}`
                      : "정보 없음"}
                  </TextBox>
                </NameBox>
              </TextWrapper>
              <TextWrapper>
                ...
                <NameBox>
                  <TextBox>
                    {foodData ? foodData.quantity : "정보 없음"}
                  </TextBox>
                </NameBox>
              </TextWrapper>
              <TextWrapper>
          ...
          <ButtonWrapper>
            ...
            {!isDate && !location && (
              <SmallButton text="수정하기" onClick={openModifyModal} />
            )}
            {showModify && (
              <ModifyModal
